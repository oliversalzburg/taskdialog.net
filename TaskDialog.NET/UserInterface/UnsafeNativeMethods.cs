...
namespace TaskDialogNet.UserInterface {
  ...
  internal static class UnsafeNativeMethods {
    ...
    internal delegate int NativeTaskDialogCallback(
      [In] IntPtr hwnd, [In] uint msg, [In] UIntPtr wParam, [In] IntPtr lParam, [In] IntPtr refData );
    ...
    internal static extern IntPtr SendMessageWithString( IntPtr hWnd, uint Msg, IntPtr wParam,
    ...
    internal struct TASKDIALOGCONFIG {
      ...
      /// Window title.
      /// </summary>
      [MarshalAs( UnmanagedType.LPWStr )] public string pszWindowTitle; // string or MAKEINTRESOURCE()
